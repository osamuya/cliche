...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="http://cliche.local/login">
                        <input type="hidden" name="_token" value="oJenbck1VSZ3jrlvuORiKmIGzkpa2V826d8q8bA3">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="http://cliche.local/password/reset">
